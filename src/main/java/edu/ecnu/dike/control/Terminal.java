...
public class Terminal implements Runnable {
    ...
    private final int[] cumWeightList;
    ...
    private final LinkedList<Integer> sleepTimeList = new LinkedList<>();
    private volatile boolean conflictFixed = false;
    private volatile boolean stopRunningSignal = false;

    public Terminal(RuntimeProperty runtimeProps, ConnectionProperty connProps, Client client,
            int threadID) {
        this.client = client;
        ...
        this.rnd = client.getRnd().newRandom();
